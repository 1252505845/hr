        ...
        <div class="fresh_mid">
        	<ul>
        		<c:forEach items="${goodsList}" var="goods">
        			<li>
	                	<div class="name"><a href="#">${goods.goodsName}</a></div>
	                    <div class="price">
	                    	<font>￥<span><fmt:formatNumber value="${goods.price}" pattern="#,##0.00"></fmt:formatNumber></span></font>
	                    </div>
	                    <div class="img"><a href="product.action?goodsId=${goods.goodsId}"><img src="images/${goods.imgPath }" width="185" height="155" /></a></div>
	                </li>
        		</c:forEach>
            	<!-- <li>
