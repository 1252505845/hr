		...
		<div class="m_right">
            ...
            <table border="0" class="acc_tab" style="width:870px;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td>${sessionScope.user.idNo}</td>
                <td class="modify_info"><input type="text" name="idNo" id="idNo" value="${sessionScope.user.idNo}"/></td>
              </tr>
              <tr>
                <td class="td_l b_none">电  话：</td>
                <td>${sessionScope.user.mobile}</td>
                <td class="modify_info"><input type="text" name="mobile" id="mobile" value="${sessionScope.user.mobile}"/></td>
              </tr>
              <tr>
                <td class="td_l">邮   箱： </td>
                <td>${sessionScope.user.email}</td>
                <td class="modify_info"><input type="text" name="email" id="email" value="${sessionScope.user.email}"/></td>
              </tr>
              <tr>
