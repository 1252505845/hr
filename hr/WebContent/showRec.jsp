...
<div><h3>欢迎  管理员    <span style="color: #EC7D16">${admin.phone}</span> </h3></div>
     <form action="showRec" method="post">
     <div class="big">
        <table border="1"  cellspacing="0" >
            ...
            <tr>
            	<td>单位</td>
            	<td><input type="text" placeholder="请输入公司名称" value="${recruit.company}" name="company"/></td>
            	<td>部门职位</td>
            	<td>
            	<span>${recruit.deptId}</span> <span>${recruit.pid}</span>
            ...
            <tr>
            	<td>地址</td>
            	<td><input type="text" name="addr" value="${recruit.addr}"placeholder="请输入公司地址"/></td>
            	<td>薪资</td>
            	<td>
            	${recruit.pay}
            ...
            <tr>
            	<td>学历</td>
            		...
            		<!-- <select name="education">
    				 ...
    				 <td>工作经验</td>
    				 <td><input type="text" name="workExperience"  value="${recruit.workExperience}"  placeholder="要求几年的工作经验"/></td>
    				
            </tr>
            <tr>
               <td>岗位要求</td>
               <td colspan="3">
                       <input type="text" name="content"  value="${recruit.content}" placeholder="岗位要求" style="width:99%">
               </td>
